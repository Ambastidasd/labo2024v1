...
corrida_guantesblancos_202109_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0901BLV", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0901BLV", "DT0901BLV" )
  
  DR_drifting_guantesblancos( "DR0901BLV", "CA0901BLV" )
  FE_historia_guantesblancos( "FE0901BLV", "DR0901BLV" )
  
  TS_strategy_guantesblancos_202109( "TS0901BLV", "FE0901BLV" )
  
  HT_tuning_AUCROC( "HT0901BLV", "TS0901BLV" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0901BLV", c("HT0901BLV","TS0901BLV") )
...
corrida_guantesblancos_202107_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0902BLV", "FE0901BLV" )
  
  HT_tuning_AUCROC( "HT0902BLV", "TS0902BLV" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0902BLV", c("HT0902BLV", "TS0902BLV") )
...
corrida_guantesblancos_202109_AUC( "gb01_AUCBLV" )


# Luego partiendo de  FE0001

corrida_guantesblancos_202107_AUC( "gb02_AUCBLV" )
