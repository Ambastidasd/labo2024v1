...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907)
  
  
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905)
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT00011-sem", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA00011-sem", "DT00011-sem" )
  
  DR_drifting_baseline( "DR00011-sem", "CA00011-sem" )
  FE_historia_baseline( "FE00011-sem", "DR00011-sem" )
  
  TS_strategy_baseline_202109( "TS00011-sem", "FE00011-sem" )
  
  HT_tuning_baseline( "HT00011-sem", "TS00011-sem" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ00011-sem", c("HT00011-sem","TS00011-sem") )
...
corrida_baseline_semillerio_202109( "basem01-ab" )
